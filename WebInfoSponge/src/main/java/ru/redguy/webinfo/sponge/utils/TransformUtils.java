...
public class TransformUtils {
    ...
    @Contract("_ -> new")
    public static @NotNull WorldBorder transform(org.spongepowered.api.world.@NotNull WorldBorder worldBorder) {
    ...
    public static @Nullable Location transform(@NotNull Map<UUID, RespawnLocation> locations) {
    ...
    @Contract("_ -> new")
    public static org.spongepowered.api.world.@NotNull Location<org.spongepowered.api.world.World> transform(@NotNull Location location) {
